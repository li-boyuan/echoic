...
const messages: Record<Locale, Record<string, string>> = {
  ...
  es: {
    ...
    "demo.desc": "Narrador IA con casting automático de voces, susurros, gritos y ritmo emocional — de texto a audiolibro en minutos.",
